...
Recast & Detour - Modificado para a atividade de IA para Jogos
===============
...
Tentando adicionar 3 tipos de Agentes
Mudanças de velocidades para cada tipo de agente em cada tipo de terreno
Mudanças de velocidade de acordo com a inclinação do terreno
Uso de heuristicas para calcular o caminho que cada agente irá realizar de acordo com seu perfil*
